                            ...
                            <div class="col-12">
                                <div class="pay_instructions">
                                    <div class="instruction_banner">
                                        <h3>bKash Payment Instructsions</h3>
                                        <p>bKash Personal No :</p>
                                        <p>01777541690</p>
                                    </div>
                                    ...
                                    <div class="intstruction_list">
                                        <ul>
                                            ...
                                            <li>Use your Username (Mariya95) as bKash Referral number.</li>
                                            <li>After sending payment put your transaction id and your bkash number in the form below.</li>
                                        </ul>
                                    </div>
                                </div>
