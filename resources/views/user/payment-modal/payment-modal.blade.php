                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home">Existing</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu1">New</a></li>
                            </ul>
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <div class="check-box-list">
                                                <div id="balanceAlart"></div>
                                                <div id="balanceAlartTopper"></div>
                                            </div>
                                        </div>
                                        <div id="insertRefId">
                                            <div class="form-group">
                        ...
                        <div class="col-12 my-3" id="packageDetails">
                            <div class="">
